...
From the square root definition, we can begin deriving rules:

|---|---| |Let ${a, b \in \R_{\geq 0}}$| Assumption |
|${(\sqrt{a})^2 (\sqrt{b})^2 = ab}$ | Definition of Square Root |
|${(\sqrt{a})^2 (\sqrt{b})^2 = (\sqrt{a} \cdot \sqrt{b})^2}$ | The Power
Product Rule of Exponents | | ${(\sqrt{a} \cdot \sqrt{b})^2 = ab}$ | The
Transitive Property of Equality |
|${\sqrt{a} \cdot \sqrt{b} \in \R_{\geq 0} }$ | The product of non-negative
numbers is non-negative | | ${ab \in \R_{\geq 0}}$ | Id.; The Transitive
Property of Equality | | There is exactly one ${n \in \R_{\geq 0}}$ such
that ${n = (\sqrt{ab})^2 = ab}$ | Definition of Square Root; If
${a \in \R_{\geq 0},}$ then there is a unique ${n}$ denoted by ${\sqrt{a}}$
such that ${(\sqrt{a})^2.}$ | | ${n = \sqrt{ab} = \sqrt{a} \sqrt{b}}$ |
${n}$ is the only number with the property that ${(\sqrt{ab})^2 = ab.}$ | |
&#8756; ${\sqrt{ab} = \sqrt{a} \sqrt{b}}$ | ${\blacksquare}$ |
