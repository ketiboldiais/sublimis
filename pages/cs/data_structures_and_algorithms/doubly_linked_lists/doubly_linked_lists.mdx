...
- [Doubly Linked Lists](#doubly-linked-lists)
  - [Insertion: Doubly-linked Lists](#insertion-doubly-linked-lists)
    - [Prepending](#prepending)
  - [Appending to a Doubly Linked List](#appending-to-a-doubly-linked-list)
  - [Deletion](#deletion)
    - [Head Deletion](#head-deletion)
    - [Tail Node Deletion](#tail-node-deletion)
