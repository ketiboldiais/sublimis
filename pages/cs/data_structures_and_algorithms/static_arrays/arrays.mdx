...
import { TableMatrix } from "@illus/TableMatrix";
import { HTree } from "@illus/HTree";
import ArraysAsObjects from "./arrays_as_objects.mdx";
...
23. [Bitsets: Search-and-rescue for Unsorted Arrays](#bitsets-search-and-rescue-for-unsorted-arrays)
24. [Duplicate Handling](#duplicate-handling)
25. [Duplicate Spotters: Identifying Duplicates in a Sorted Sequence](#duplicate-spotters-identifying-duplicates-in-a-sorted-sequence)
26. [Useful Applications](#useful-applications)
27. [Finding the Total Number of Duplicates](#finding-the-total-number-of-duplicates)
28. [Duplicate Counter: Counting Duplicates in an Unsorted Sequence](#duplicate-counter-counting-duplicates-in-an-unsorted-sequence)
29. [Pair to Sum: Unsorted Arrays](#pair-to-sum-unsorted-arrays)
30. [Pair to Sum: Sorted Arrays](#pair-to-sum-sorted-arrays)
31. [Finding a Minimum and a Maximum in a Single Scan](#finding-a-minimum-and-a-maximum-in-a-single-scan)
32. [Array Addressing](#array-addressing)
33. [Linear Search](#linear-search)
34. [Transposition](#transposition)
35. [Move-to-head](#move-to-head)
36. [Maximum Finder](#maximum-finder)
37. [Minimum Finder](#minimum-finder)
38. [Reversing Array Elements](#reversing-array-elements)
39. [Reversing with an Auxiliary Array](#reversing-with-an-auxiliary-array)
40. [Reversing in Place](#reversing-in-place)
41. [Rotating an Array](#rotating-an-array)
42. [Shifting Array Elements](#shifting-array-elements)
43. [Checking if an Array is Sorted](#checking-if-an-array-is-sorted)
44. [Sorted Insertion](#sorted-insertion)
45. [Summing Elements](#summing-elements)
46. [Arithmetic Mean](#arithmetic-mean)
47. [Cost-benefit Analysis: Arrays](#cost-benefit-analysis-arrays)
