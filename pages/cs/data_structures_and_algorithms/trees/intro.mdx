...
- [Introduction to Trees](#introduction-to-trees)
  ...
  - [Binary Trees](#binary-trees)
    - [Tree Counting](#tree-counting)
    - [Unordered Tree Permutations](#unordered-tree-permutations)
  - [Tallest Unordered Binary Tree Permutation](#tallest-unordered-binary-tree-permutation)
  - [Ordered Tree Permutations](#ordered-tree-permutations)
  - [Height and Node Bounds](#height-and-node-bounds)
    - [Binary Shrub Sizes](#binary-shrub-sizes)
    - [Binary Lumber Size](#binary-lumber-size)
  - [Lumber Heights](#lumber-heights)
  - [Shrub Heights](#shrub-heights)
    - [Binary Tree Bounds](#binary-tree-bounds)
  - [Branch Nodes v. Leaf Nodes](#branch-nodes-v-leaf-nodes)
  - [Types of Binary Trees](#types-of-binary-trees)
    - [Rooted Binary Tree](#rooted-binary-tree)
    - [Proper Binary Tree](#proper-binary-tree)
    - [Relationship Between Height and Nodes](#relationship-between-height-and-nodes)
    - [Shrubs](#shrubs)
    - [Bounds of Proper Binary Trees](#bounds-of-proper-binary-trees)
    - [Relation: Branch Nodes and Leaves](#relation-branch-nodes-and-leaves)
    - [Complete Binary Trees](#complete-binary-trees)
    - [Perfect Binary Tree](#perfect-binary-tree)
    - [Balanced Binary Tree](#balanced-binary-tree)
    - [Summary of Tree Types](#summary-of-tree-types)
  - [${k\text{-ary}}$ Trees](#ktext-ary-trees)
    - [Strict ${k\text{-ary}}$ Trees](#strict-ktext-ary-trees)
    - [Strict ${k\text{-ary}}$ Shrub Sizes](#strict-ktext-ary-shrub-sizes)
    - [Strict ${k\text{-ary}}$ Timber Sizes](#strict-ktext-ary-timber-sizes)
    - [Strict ${k\text{-ary}}$ Shrub Heights](#strict-ktext-ary-shrub-heights)
    - [Strict ${k\text{-ary}}$ Timber Heights](#strict-ktext-ary-timber-heights)
    - [Relationship: Leaves & Branch Nodes](#relationship-leaves--branch-nodes)
...
> _Definition_: A ${k\text{-ary}}$ tree is a rooted tree where each node
...
A **ternary tree** is a ${3\text{-ary}}$ tree, so ${k=3.}$ Thus, in a
...
Similarly, a ${4\text{-ary}}$ tree is a tree where each node only has
either ${0,}$ ${1,}$ ${2,}$ ${3,}$ or ${4}$ children.

### Strict ${k\text{-ary}}$ Trees

A _strict ${k\text{-ary}}$ tree_ is a ${k\text{-ary}}$ tree where each node
has either (1) zero children or (2) exactly ${k}$ children.

> _Definition_. Let ${T}$ be a ${k\text{-ary}}$ tree. ${T}$ is a _strict
> ${k\text{-ary}}$ tree_ iff every node in ${T}$ has a ${0}$ or ${k}$
> children.
...
either ${0}$ or ${3}$ children. A **strict ${4\text{-ary}}$ tree** is a
${4\text{-ary}}$ tree where every node has either ${0}$ or ${4}$ children.
And so on.

### Strict ${k\text{-ary}}$ Shrub Sizes

The shrub size lemmas we saw earlier apply to strict ${k\text{-ary}}$
trees.

> _Lemma: Strict ${k}$-ary Shrub Sizes_. Let ${H \in \Z+}$ and
> ${k \in \Z+.}$ The minimum number of nodes, i.e., the _minimum size_,
> necessary to achieving a ${k\text{-ary}}$ tree of height ${H}$ is the
...
### Strict ${k\text{-ary}}$ Shrub Heights

The strict ${k\text{-ary}}$ lumber size lemma yields the strict
${k\text{-ary}}$ shrub height lemma: The smallest possible height strict
${k\text{-ary}}$ tree given ${N}$ nodes.
...
> ${N}$ nodes, the shortest possible height strict ${k\text{-ary}}$ tree,
...
### Strict ${k\text{-ary}}$ Timber Heights

By a similar line of reasoning, we can derive the strict ${k\text{-ary}}$
timber height lemma from the strict ${k\text{-ary}}$ shrub size lemma: The
_tallest_ possible height strict ${k\text{-ary}}$ tree given ${N}$ nodes.
...
> ${N}$ nodes, the tallest possible height strict ${k\text{-ary}}$ tree,
...
${k\text{-ary}}$ tree and its branch nodes.
